              ...
              <?php else: ?>
                <div class="col-12 mt-5 text-center">
                  ...
                  <ul class="list-inline">
                    <a class="btn btn-outline-dark btn-sm mx-1" class="text-dark list-inline-item" href="dashboard.php">
                      Dashboard
                    </a>
                    <a class="btn btn-outline-dark btn-sm mx-1" class="text-dark list-inline-item" href="profile.php">
                      Profile
                    </a>
                  </ul>
                </div>
